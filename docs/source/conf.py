...
htmlhelp_basename: str = 'picosigndoc'
latex_elements: dict[object, object] = {}
latex_documents: list[tuple[object, ...]] = [(
    root_doc, 'picosign.tex', 'picosign Documentation',
    'Vladimir Roncevic \\textless{}elektron.ronca@gmail.com\\textgreater{}',
    'manual'
)]
man_pages: list[tuple[object, ...]] = [(
    root_doc, 'picosign', 'picosign Documentation', [author], 1
)]
texinfo_documents: list[tuple[object, ...]] = [(
    root_doc, 'picosign', 'picosign Documentation', author, 'picosign',
    'UF2 firmware binary signature tool.', 'Miscellaneous'
)]
