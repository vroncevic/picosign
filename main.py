...
Info
    Main entry point for PicoSign CLI.
'''
...
def main() -> bool:
    '''
        Bootstraps and runs the picosign with required adapters.

        :return: True if successful, False otherwise.
        :exceptions: None.
    '''
    picosign: PicoSign = PicoSign(PicoSignBundleFactory.create_bundle())

    return picosign.process()


if __name__ == '__main__':
    '''
        Entry point for picosign execution.
