...
Info
    Defines application service for UF2 signature operations.
'''
...
class Service:
    '''
        Service for orchestrating the UF2 signature operations.
        ...
        It defines:
            ...
            :methods:
                ...
                | execute - Executes UF2 signature operations.
                | is_initialized - Checks if the service is initialized.
    '''

    _subprocessor: ISubProcessor[Mapping[str, object], Mapping[str, object]]

    def __init__(self, subprocessor: ISubProcessor[Mapping[str, object], Mapping[str, object]]) -> None:
        '''
    ...
    def execute(self, *, params: Mapping[str, object]) -> Mapping[str, object]:
        '''
            Executes UF2 signature operations.

            :param params: The parameter mapping containing command data.
