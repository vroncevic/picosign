...
Info
    Defines domain model for UF2 signature operations.
'''
...
class SignatureData:
    '''
        ...
        It defines:
            ...
            :attributes:
                | file_path - Path to the UF2 file.
                | signature - Textual signature to embed or read (default None).
                | output_path - Path to the output UF2 file (default None).
    '''
