...
Info
    Defines SignCommandExecutor class.
'''
...
class SignCommandExecutor:
    '''
        Command executor strategy for adding signature to UF2 file.
        ...
        It defines:
            ...
            :methods:
                ...
                | __str__ - Returns the SignCommandExecutor as string representation.
    '''
    ...
    def __str__(self) -> str:
        '''
            Returns the SignCommandExecutor as string representation.

            :return: The SignCommandExecutor as string representation.
        '''
        return to_str(self)
