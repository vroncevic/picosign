    ...
    def create_bundle(cls, dependencies: CLIBundleDependencies) -> CLIBundle:
        '''
            ...
            :exceptions:
                ...
                | ATSTypeError:  The CLI bundle must be an instance of CLIBundle and its
                |                attributes must be instances of their respective types.
        '''
        ...
        commands: Sequence[CommandBundle] | None = dependencies.get(CLIBundleKeys.DEPENDENCY_COMMANDS) if dependencies else None
