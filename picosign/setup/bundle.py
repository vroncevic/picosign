...
class PicoSignBundle:
    '''
        PicoSign bundle holding the components of the picosign tool.

        It defines:

            :attributes:
                | base - The base bundle with the base components.
                | service - The service orchestrating the picosign's execution.
                | subprocessor - The adapter executing the picosign's sub-processes.
                | cli - The command-line interface adapter.
            :methods:
                | to_dict - Converts the picosign bundle to a dictionary.
    '''
    ...
    def to_dict(self) -> dict[str, object]:
        '''
            Converts the picosign bundle to a dictionary.

            :return: Dictionary representation of the picosign bundle.
            :exceptions: None.
        '''
