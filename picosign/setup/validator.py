...
Info
    A validator for the picosign bundle.
'''
...
class PicoSignBundleValidator:
    '''
        ...
        It defines:
            ...
            :methods:
                | validate - Validates the picosign bundle.
                | is_valid - Checks if the picosign bundle is valid.
    '''

    @classmethod
    def validate(cls, bundle: PicoSignBundle) -> None:
        '''
            Validates the picosign bundle.

            :param bundle: The picosign bundle to be validated.
            :exceptions:
        ...
        '''
        ctx: str = 'picosign_bundle_validator::validate(...)'
        msg_bundle_none: str = 'the picosign bundle must be provided'
        msg_bundle_istype: str = 'the picosign bundle must be an instance of PicoSignBundle'
        ...
        istype(bundle, PicoSignBundle, ctx, msg_bundle_istype)
    ...
    @classmethod
    def is_valid(cls, bundle: PicoSignBundle) -> bool:
        '''
            Checks if the picosign bundle is valid.

            :param bundle: The picosign bundle to be checked.
